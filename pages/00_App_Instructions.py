...
st.set_page_config(
    page_title="Instructions - MigNarUK",
    layout="wide",
...
st.title("📖 MigNarUK Platform Instructions")

st.markdown("""
Welcome to the **MigNarUK Platform**! This application is designed to help researchers explore, validate, and refine artificial intelligence extractions of migration narratives.
