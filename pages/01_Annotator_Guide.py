...
st.set_page_config(
    page_title="Annotator Guide - MigNarUK",
    layout="wide",
...
st.info("These notes guide annotators working on the **[Seeing Migration Narratives (MigNarUK)](https://mignaruk.streamlit.app/)** project.")
...
st.markdown("""
1. Sign in to the [MigNarUK app](https://mignaruk.streamlit.app/)
2. Navigate to the **[Narratives Taxonomy](https://mignaruk.streamlit.app/Narratives_Taxonomy)** page
...
1. Click the **"View on Articles"** button (this will take you to the **[Narratives on Articles](https://mignaruk.streamlit.app/Narratives_on_Articles)** page)
...
st.markdown("""
1. **[Sign in](https://mignaruk.streamlit.app/)**.
2. Open the **Excel file** you received — each row has a clickable link to an article or parliamentary statement.
3. Click a link → the **[Narratives on Articles](https://mignaruk.streamlit.app/Narratives_on_Articles)** page opens.
...
st.divider()
st.caption("Narratives in Motion: Large-Scale Tracking of Migration Discourse Across Media and Parliament")